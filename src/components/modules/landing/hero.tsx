                ...
                <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
                    <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
                        ...
                        >
                            <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                                Build with <strong>Legacy</strong><br />
                                {/* <em className="italic">smoothly</em> <span>&</span> <em className="italic">effortlessly</em> */}
                            </h1>
                            <h2 className="text-4xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-6"> <em className="italic">Your will on chain forever protected</em></h2>
                        </motion.div>
                        ...
                        >
                            Create your comprehensive digital will with assets, beneficiaries, and automated distribution using this smart will builder.
                        </motion.p>
                            ...
                            <div className="flex items-center justify-center">
                                <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                                    <div className="border border-border bg-primary h-[40px] rounded-full flex items-center justify-center text-primary-foreground">
                                        <Button className="font-medium tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base"
                    ...
                    >
                        <div className="text-center">
                            <p className="text-sm text-muted-foreground mb-6">Your legacy on-chain, forever protected.</p>
